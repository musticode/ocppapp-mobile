    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        <View style={styles.stationRow}>
          <View style={{ flex: 1 }}>
            <Text style={styles.stationName}>Vehicle Info</Text>
          </View>
        </View>
        <View style={styles.metricsRow}>
          <View style={styles.metricCol}>
            <Text style={styles.metricLabel}>Make</Text>
            <Text style={styles.metricLabel}>{vehicle.make}</Text>
          </View>
        </View>
        <View style={styles.metricsRow}>
          <View style={styles.metricCol}>
        ...
        <View style={styles.metricsRow}>
          <View style={styles.metricCol}>
            ...
            <Text style={styles.metricLabel}>{vehicle.year}</Text>
          </View>
        </View>
      </View>
    </View>
